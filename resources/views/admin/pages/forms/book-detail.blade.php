...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="../../assets/admin/vendors/select2-bootstrap-theme/select2-bootstrap.min.css">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        ...
        <ul class="nav">
            ...
            <div class="profile-desc">
              <div class="profile-pic">
                ...
                <div class="profile-name">
                  <h5 class="mb-0 font-weight-normal"> Rahul Sarkar</h5>
          ...
          <li class="nav-item menu-items">
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="display">Books Details table</a></li>
                <li class="nav-item"> <a class="nav-link" href="contact_display">Contact Table</a></li>
                <li class="nav-item"> <a class="nav-link" href="bookdisplay">book PDF</a></li>
          ...
          <li class="nav-item menu-items">
            <a class="nav-link" data-toggle="collapse" href="#ui-form" aria-expanded="false" aria-controls="ui-basic">
              <span class="menu-icon">
            ...
            <div class="collapse" id="ui-form">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="form">Book Elements</a></li>
                <li class="nav-item"> <a class="nav-link" href="book">Book PDf</a></li>
              ...
              <li class="nav-item dropdown">
                <a class="nav-link" id="profileDropdown" href="#" data-toggle="dropdown">
                  <div class="navbar-profile">
                    <img class="img-xs rounded-circle" src="../../assets/admin/images/faces/face15.jpg" alt="">
                    <p class="mb-0 d-none d-sm-block navbar-profile-name"> Rahul Sarkar</p>
...
<?php
if (isset($_REQUEST['imgsuccess'])) {
    echo "<script>
    Swal.fire({
        position: 'center',
        icon: 'success',
        color:'red',
        title: 'Chat date updated!!!',
        showConfirmButton: false,
        timer: 1500
    })
    </script>";
              ...
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <form action="{{Route('table-update', $show->id)}}" method="POST" enctype="multipart/form-data" class="forms-sample">
                      @csrf

                      <div class="form-group">
                        <label for="title">Title</label>
                        <input type="text" name="title" class="form-control" id="exampleInputName1" placeholder="Enter Book Name" value="{{$show->title}}">
                      </div>
                      <div class="form-group">
                        <label for="author_name">Author Name</label>
                        <input type="text" name="author_name" class="form-control" id="exampleInputName1" placeholder="Enter Author Name" value="{{$show->author_name}}">
                      </div>
                      <div class="form-group">
                        <label for="price">Price</label>
                        <input type="text" class="form-control" id="price" name="price" placeholder="Book Price" value="{{$show->price}}">
                      </div>
                      <div class="form-group">
                        <label for="Description">Description</label>
                        <input type="text" class="form-control" name="description" id="Description" placeholder="Enter book Description" value="{{$show->description}}">
                      </div>
                     
                     
                      <div class="form-group">
                        <label for="author">Author</label>
                        <input type="text" class="form-control" name="author" id="author" placeholder="detail of author" value="{{$show->author}}">
                      </div>
                      <div class="form-group">
                        <label for="comment">Comment</label>
                        <textarea class="form-control" name="comment" id="exampleTextarea1" rows="4" placeholder="Enter books comment" value="{{$show->comment}}"></textarea>
                      </div>


                      <div class="form-group">
                        <label for="pid">Book PDF ID</label>
                        <input type="text" class="form-control" name="pid" id="Description" placeholder="Enter book reference id" value="{{$show->pid}}">
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="input-group col-xs-12">
                          <input type="text" class="form-control file-upload-info" disabled="" placeholder="Upload Image" value="{{$show->image}}">
