...
<?php
if (isset($_REQUEST['pdfsuccess'])) {
    echo "<script>
    Swal.fire({
        position: 'center',
        icon: 'success',
        color:'red',
        title: 'Pdf has been stored!!!',
        showConfirmButton: false,
        timer: 1500
    })
    </script>";
...
?>
              ...
              {{-- <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <form action="image_insert" method="POST" enctype="multipart/form-data" class="forms-sample">
                     @csrf
              ...
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Book  PDF</h4>
                    <p class="card-description">PDF Details </p>
                    <form action="{{$display->pid}}" method="POST" enctype="multipart/form-data" class="forms-sample">
                      @csrf
                      ...
                      <div class="form-group">
                        ...
                        <input type="file" name="file" class="file-upload-default">
                        <div class="input-group col-xs-12">
                          <input type="text" class="form-control file-upload-info" disabled="" placeholder="Upload Book Pdf" value="{{$display->file}}">
                          <span class="input-group-append">
                            <button class="file-upload-browse btn btn-primary" type="button">Upload</button>
                          </span>
                        </div>
