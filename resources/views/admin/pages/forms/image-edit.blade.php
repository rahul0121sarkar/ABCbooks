              ...
              {{-- <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <form action="{{route('poster-update',$show->id)}}" method="POST" enctype="multipart/form-data" class="forms-sample">
                     @csrf
                      ...
                      <div class="form-group">
                        ...
                        <div class="input-group col-xs-12">
                          <input type="text" class="form-control file-upload-info" disabled="" placeholder="Upload Image" value="{{$show->file}}">
